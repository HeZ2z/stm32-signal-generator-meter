...
/* M8 单通道示波页的 ADC 采样与 LCD 刷新参数。 */
#define APP_SCOPE_SAMPLE_COUNT 320U
#define APP_SCOPE_DMA_BUFFER_SIZE 512U
#define APP_SCOPE_SIGNAL_TIMEOUT_MS 300U
...
#define APP_SCOPE_ADC_PIN GPIO_PIN_0
#define APP_SCOPE_ADC_CHANNEL ADC_CHANNEL_0
